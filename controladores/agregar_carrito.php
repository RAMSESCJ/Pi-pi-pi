...
//busca si el usaurio tiene un carrito activo
$carritoActivo=$venta->verCarrito(1);// le envio un 1 porque deje un usuario estatico, pero deberia de ser el usuario logueado usando por ejemplo $_SESSION['idusuario'];
